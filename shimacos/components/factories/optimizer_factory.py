...
def get_adam(params, lr):
    optimizer = Adam(params=params, lr=lr)
    return optimizer


def get_adamw(params, lr):
    optimizer = AdamW(params=params, lr=lr)
    return optimizer


def get_sgd(params, lr):
    optimizer = SGD(params=params, lr=lr, momentum=0.9, weight_decay=1e-4)
    return optimizer


def get_radam(params, lr):
    optimizer = RAdam(params=params, lr=lr)
    return optimizer
